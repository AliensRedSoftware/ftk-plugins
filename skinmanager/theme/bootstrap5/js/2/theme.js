    ...
    $('#theme').change(function(){
        ...
        switch(theme){
            case 'Светло-белая':
                ...
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "Светло-белая");
            break;
            case 'Светло-синия':
                //utility
                ...
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "Светло-синия");
            break;
            case 'Светло-зеленная':
                ...
                $('.badge-'+getBadgePreview()).removeClass('badge-'+getBadgePreview()).toggleClass('badge-light');
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "Светло-зеленная");
            break;
            case 'Светло-голубая':
                //utility
                ...
                $('.badge-'+getBadgePreview()).removeClass('badge-'+getBadgePreview()).toggleClass('badge-light');
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "Светло-голубая");
            break;
            case 'Светло-желтая':
                //utility
                ...
                $('.badge-'+getBadgePreview()).removeClass('badge-'+getBadgePreview()).toggleClass('badge-dark');
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "Светло-желтая");
            break;
            case 'Светло-красная':
                 //utility
                ...
                $('.badge-'+getBadgePreview()).removeClass('badge-'+getBadgePreview()).toggleClass('badge-light');
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "Светло-красная");
            break;
            case 'Тёмная':
                //utility
                ...
                $('.badge-'+getBadgePreview()).removeClass('badge-'+getBadgePreview()).toggleClass('badge-light');
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "Тёмная");
            break;
            case 'gentoo':
                //utility
                ...
                //cookie
                Cookies.set("__SKINMANAGER-bootstrap5-THEME", "gentoo");
            break;
            default:
                //utility
                document.querySelector("html").style.backgroundColor='#fff';
...
function getThemeBootstrap(){
    if (Cookies.get('__SKINMANAGER-bootstrap5-THEME')!='undefined'){
        return Cookies.get('__SKINMANAGER-bootstrap5-THEME');
    } else {
        return false;
    }
}
